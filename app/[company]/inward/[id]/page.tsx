      ...
      <div className="grid gap-4 sm:gap-6 xl:grid-cols-3">
        ...
        <thead>
          <tr className="bg-gray-50 border-b border-gray-200">
            ...
            <th className="px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm font-medium text-gray-700">Count</th>
                        ...
                        <tbody>
                          {boxes.map((box, index) => (
                            <tr key={`${box.transaction_no}-${box.article_description}-${box.box_number}`} className="hover:bg-gray-50 border-b border-gray-200 last:border-b-0">
                              ...
                              <td className="px-3 sm:px-4 py-2 sm:py-3">
                                <span className="text-xs sm:text-sm">{box.count || 1}</span>
                              </td>
                              <td className="px-3 sm:px-4 py-2 sm:py-3">
