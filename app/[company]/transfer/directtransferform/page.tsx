...
export default function NewTransferRequestPage({ params }: NewTransferRequestPageProps) {
  ...
  const [itemSearchResults, setItemSearchResults] = useState<Record<string, Array<{ id: number; item_description: string; material_type?: string; group?: string; sub_group?: string }>>>({})
