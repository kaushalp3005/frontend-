            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 px-4 sm:px-5 py-3 sm:py-4 border-b bg-white">
              ...
              <div className="flex items-center gap-2 self-end sm:self-auto">
                ...
                <Button variant="ghost" size="sm" onClick={() => loadTransfers(transfersPage)} disabled={transfersLoading}
                  ...
                  <RefreshCw className={`h-3.5 w-3.5 mr-1.5 ${transfersLoading ? 'animate-spin' : ''}`} />
                  Refresh
                </Button>
              </div>
            </div>
                  ...
                  {transfers.map((t) => (
                    <div key={t.id} className="p-4 space-y-3">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {t.request_id && t.pending_items > 0 && (
                      ...
                      {transfers.map((t) => (
                        <tr key={t.id} className="hover:bg-gray-50/50 transition-colors">
                          ...
                          <td className="py-3 px-4">
                            ...
                            {t.request_id && t.pending_items > 0 && <p className="text-[11px] text-orange-600 font-medium mt-1">{t.pending_items} pending</p>}
                          </td>
                          <td className="py-3 px-4">
                            <div className="flex items-center justify-end gap-1.5">
                              <Button variant="outline" size="sm"
