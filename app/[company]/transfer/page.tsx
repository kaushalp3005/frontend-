    ...
    <div className="p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-5 lg:space-y-6 bg-gray-50 min-h-screen">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <Card className="border-0 shadow-sm overflow-hidden">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 px-4 sm:px-5 py-3 sm:py-4 border-b bg-white">
              ...
              <div className="flex items-center gap-2 flex-wrap self-end sm:self-auto">
                <Button
                  size="sm"
                  className="h-8 px-2.5 sm:px-3 text-[11px] sm:text-xs bg-blue-600 hover:bg-blue-700 text-white shadow-sm"
                  onClick={() => router.push(`/${company}/transfer/innercoldtransfer`)}
                >
                  <Plus className="h-3.5 w-3.5 mr-1" />
                  <span className="hidden sm:inline">Inner Cold Transfer</span><span className="sm:hidden">Inner Cold</span>
                </Button>
                <Button
                  size="sm"
        ...
        <TabsContent value="innercold" className="mt-4 space-y-4">
          <Card className="border-0 shadow-sm overflow-hidden">
            <SectionHeader title="Inner Cold Transfers" count={innerColdTotal}
              onRefresh={() => loadInnerColdTransfers(innerColdPage)} isLoading={innerColdLoading} />
