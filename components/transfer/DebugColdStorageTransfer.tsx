  ...
  const runDebugTests = async () => {
    ...
    try {
      ...
      results.tests.push({
        ...
        status: "✅ INFO",
        details: {
          expectedNames: ["Rishi", "Savla D-39", "Savla D-514", "Supreme"],
          note: "Canonical cold warehouse codes. Legacy aliases (Savla, Old Savla, Savla Bond, Rishi cold, etc.) are normalized to these via normalizeWarehouseName()."
        }
      })
