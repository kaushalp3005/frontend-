...
type Opt = { value: string; label: string; id?: number; uom?: number | null }
...
/**
 * CATEGORIAL ITEM DESCRIPTIONS (from categorial_inv table via interunit endpoint)
 * Used by transfer forms to fetch item descriptions with UOM data.
 */
