...
export type DestinationLocation = "W202" | "A185" | "A101" | "A68" | "F53" | "Cold Storage"
...
export const ALLOWED_UOMS = [
  "KG", "GM", "PCS", "CTN", "BOX", "BAG", "PKT", "LTR", "ML", "MTR", "CM", "SQM", "SQF", "TON", "QTL"
] as const
...
export const interUnitChallanEnhancedSchema = z.object({
  ...
  lines: z.array(z.object({
    ...
    uom: z.enum(["KG", "GM", "PCS", "CTN", "BOX", "PKT", "LTR", "ML", "MTR", "CM", "SQM", "SQF", "TON", "QTL"]).optional(),
